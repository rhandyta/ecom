        ...
        <div class="container">
                                    ...
                                    <div class="col-md-12 mb-3" wire:ignore>
                                        ...
                                        <div class="d-md-flex align-items-start">
                                            <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                <button class="nav-link activefw-bold" id="cashOnDeliveryTab-tab" data-bs-toggle="pill" data-bs-target="#cashOnDeliveryTab" type="button" role="tab" aria-controls="cashOnDeliveryTab" aria-selected="true">Cash on Delivery</button>
            ...
            @else
                <div class="card card-body shadow text-center p-md-5">
                    ...
                    <a href="{{ route('categories') }}" class="btn btn-warning">Shopping Now</a>
                </div>
            @endif
        </div>
    </div>
...
@push('scripts')
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=ATbsiSbWLH5-4WatR5nwQ3OfZX77XlzQHf0Kl5gvzte9OCPhBjVwrJlX42HSRLQHE6z8iv_b6CZFXoTA&currency=USD"></script>
    <script>
        paypal.Buttons({
            onClick: function()  {
